...
// bigginer 1
const names: string[]=["ali","khan ", "jan"];
console.log(`The content of this arry is ${names}`);


// bigginer 2

const names1: string[]=["ali","khan ", "jan"];
...
const names3: string[]=["ali","khan ", "jan"];
names3.pop();
console.log(`the content of remove arry is ${names3}`);

// biggener 4

const names4: string[]=["ali","khan ", "jan"];
names4.sort();
...
const names5: string[]=["ali","khan ", "jan"];
let i;
